...
test_dataset = load_dataset("mozilla-foundation/common_voice_11_0", "ja", split="test[:2%]")
...
resampler = lambda sr, y: librosa.resample(y.numpy().squeeze(), orig_sr=sr, target_sr=16_000)
